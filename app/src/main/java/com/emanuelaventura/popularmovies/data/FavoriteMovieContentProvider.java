...
import static com.emanuelaventura.popularmovies.data.FavoriteMovieContract.FavoriteMovieEntry.TABLE_NAME;

public class FavoriteMovieContentProvider extends ContentProvider {

    // Define final integer constants for the directory of favoritemovies and a single item.
    ...
    public static UriMatcher buildUriMatcher() {
        ...
        /*
          ...
          The two calls below add matches for the favoritemovies directory and a single item by ID.
         */
        uriMatcher.addURI(FavoriteMovieContract.AUTHORITY, FavoriteMovieContract.PATH_FAVORITE_MOVIES, FAVORITE_MOVIES);
        uriMatcher.addURI(FavoriteMovieContract.AUTHORITY, FavoriteMovieContract.PATH_FAVORITE_MOVIES + "/#", FAVORITE_MOVIES_WITH_ID);
    ...
    public Uri insert(@NonNull Uri uri, ContentValues values) {
        //Get access to the favoritemovies database (to write new data to)
        final SQLiteDatabase db = mFavoriteMovieDbHelper.getWritableDatabase();

        //Write URI matching code to identify the match for the favoritemovies directory
    ...
    public Cursor query(@NonNull Uri uri, String[] projection, String selection,
        ...
        // Query for the favoritemovies directory and write a default case
        switch (match) {
            // Query for the favoritemovies directory
            case FAVORITE_MOVIES:
            ...
            case FAVORITE_MOVIES_WITH_ID:
                // Get the favoritemovie ID from the URI path
    ...
    public int delete(@NonNull Uri uri, String selection, String[] selectionArgs) {
        ...
        int match = sUriMatcher.match(uri);
        // Keep track of the number of deleted favoritemovies
        ...
        switch (match) {
            ...
            case FAVORITE_MOVIES_WITH_ID:
                ...
                favoritemovieDeleted = db.delete(TABLE_NAME, "_id=?", new String[]{id});
                break;
            default:
                throw new UnsupportedOperationException("Unknown uri: " + uri);
        }
